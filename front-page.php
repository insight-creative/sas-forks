...
<main role="main">
  ...
  <section class="section container">
    ...
    <div class="cf">
      <div class="col-50 cf">
        <div class="col-20">
          <span class="mv icon-highlight"><i class="fa fa-check"></i></span>
        </div>
        <div class="col-80">
        ...
        <div class="col-20">
          <span class="mv icon-highlight"><i class="fa fa-arrows-alt"></i></span>
        </div>
        <div class="col-80">
        ...
        <div class="col-20">
          <span class="mv icon-highlight"><i class="fa fa-share-alt"></i></span>
        </div>
        <div class="col-80">
  ...
  <section class="section section-inverse cover" style="background-image: url(<?php get_image_uri('contact-background.jpg'); ?>);">
    <div class="container text-center">
      ...
      <a class="btn btn-inverse" href="/usa-distributors/">Contact us now</a>
    </div>
  </section>
</main>
